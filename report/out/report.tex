...
%\begin{table}[h!]
 % \centering
 % \caption{Previous Year's Results}
 % \label{year1}
 % \begin{tabular}{l|l}
...
\fi
\def\lilypondbook{}%
\input{1b/lily-61386097-systems.tex}
\ifx\postLilyPondExample \undefined
\else
  \expandafter\postLilyPondExample
\fi
...
\fi
\def\lilypondbook{}%
\input{52/lily-7d3f8df7-systems.tex}
\ifx\postLilyPondExample \undefined
\else
  \expandafter\postLilyPondExample
\fi
...
\begin{center}
\includegraphics[scale=0.5]{lstmlabel}
\end{center}
